...
from api.services.geospatial.image import append_discrete_legend, append_continuous_colorbar
from api.schemas.property_stats import PropertyStats, PastureStats, TopographicStats
from api.schemas.property_stats import (
    Value, 
    BiomassStats,
    AgeData,
    AgeStats,
...
def query_topographic_stats(coords: List[List[List[List[float]]]]):
    from api.schemas.property_stats import Value
