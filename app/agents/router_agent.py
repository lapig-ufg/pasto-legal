...
def get_instructions(run_context: RunContext) -> str:
    instructions = textwrap.dedent(f"""
        ...
        ### 1. {RouteEnum.ANALYST.value} (Analista Técnico e Agronômico)
        ...
        ### 2. {RouteEnum.MANAGER.value} (Gerente de Cadastro e Propriedades)
        ...
        ### 3. {RouteEnum.QUESTION_ANSWER.value} (Guia e FAQ do Sistema Pasto Legal)
        ...
        ### 4. {RouteEnum.SMALL_TALK.value} (Conversas Informais, Saudações e Cortesia)
