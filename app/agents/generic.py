...
generic_agent = Agent(
    ...
    role="Responsável por responder a dúvidas do usuário em relação a imagens fornecidas por ele. Capaz de interpretar imagens fornecidas pelo usuário. APENAS chamar quando o usuário disser [USER INPUT]",
