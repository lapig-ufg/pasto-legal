...
1. **Coletar Dados**: Utilize a ferramenta `get_pasture_stats` para recuperar a biomassa de pastagem (matéria seca) da propriedade.
...
3. **Calcular**: Calcule o resultado da expressão matemática formulada.
